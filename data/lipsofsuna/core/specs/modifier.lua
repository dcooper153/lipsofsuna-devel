...
local ModifierSpec = Spec:register("ModifierSpec", "modifier", {
	...
	{name = "effect", type = "string", description = "Named of the sound effect to play when the modifier is applied."},
	{name = "effect_fire", type = "string", description = "Named of the sound effect to play when the modifier is fire in a ranged spell."},
