...
Itemspec.introspect = Introspect{
	...
	fields = {
		...
		{name = "animation_attack", type = "string", description = "Attack animation name for creatures wielding the item."},
		{name = "animation_charge", type = "string", description = "Charge animation name for creatures wielding the item."},
		{name = "animation_hold", type = "string", description = "Hold animation name for creatures wielding the item."},
