...
Species{
	...
	equipment_slots = {
		...
		{name = "upperbody"}},
	factions = {"good"},
	feat_anims = {"build", "missile spell", "right hand", "ranged", "ranged spell", "spell on self", "spell on touch", "throw"},
	feat_effects = {"home","follow","berserk", "black haze", "dig", "fire damage", "firewall", "light", "mindless march", "physical damage", "restore health", "sanctuary", "travel", "wilderness"},
	footstep_height = 0.3,
