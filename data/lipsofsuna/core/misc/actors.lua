...
Species{
	...
	equipment_slots = {
		...
		{name = "upperbody"}},
	factions = {"good"},
	feat_anims = {"area spell", "build", "missile spell", "right hand", "ranged", "ranged spell", "spell on self", "spell on touch", "throw"},
	feat_effects = {"home", "follow", "frost vortex", "berserk", "black haze", "dig", "fire damage", "firewall", "light", "mindless march", "physical damage", "regeneration", "restore health", "sanctuary", "travel", "wilderness"},
	footstep_height = 0.3,
