...
Species{
	...
	feat_effects = {"home", "follow", "frost vortex", "berserk", "black haze", "dig", "fire damage", "firewall", "light", "mindless march", "physical damage", "restore health", "sanctuary", "travel", "wilderness"},
	footstep_height = 0.3,
