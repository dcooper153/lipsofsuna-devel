...
Main.messaging:register_message{
	...
	server_to_client_encode = function(self, id, mine, character, message)
		return {"uint32", id, "bool", mine, "string", character, "string", message}
	end,
	...
	server_to_client_handle = function(self, id, mine, character, message)
		-- Find the object.
		local obj = Main.objects:find_by_id(id)
		if not obj then return end
		-- Update the dialog.
		obj:set_client_dialog("message", character, message)
