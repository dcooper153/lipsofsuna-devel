...
Views.Help.new = function(clss)
	...
	-- About.
	local label_about = Widgets.Label{text = fmt(
...
if you post there.]])}
	-- Controls.
	local label_controls = Widgets.Label{text =
...
* Left control: Camera rotation mode]]}
	-- Hints.
	local label_hints = Widgets.Label{text = fmt(
...
things.]])}
	-- Contributing.
	local label_contributing = Widgets.Label{text = fmt(
...
work isn't an obstacle at least.]])}
	-- Main.
	label_about:set_request{width = 400}
	label_controls:set_request{width = 400}
	label_hints:set_request{width = 400}
	label_contributing:set_request{width = 400}
