...
Chargen.apply = function(clss)
	local packet = Packet(packets.CHARACTER_CREATE,
		...
		"uint8", clss.skills:get_value("dexterity"),
		"uint8", clss.skills:get_value("health"),
		"uint8", clss.skills:get_value("intelligence"),
		"uint8", clss.skills:get_value("perception"),
		"uint8", clss.skills:get_value("strength"),
		"uint8", clss.skills:get_value("willpower"),
