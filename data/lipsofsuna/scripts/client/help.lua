...
Help.init = function(clss)
	-- About.
	clss.group_about = Group{cols = 1}
	clss.group_about:append_row(Button{style = "label", text =
...
if you post there.]]})
	-- Controls.
	clss.group_controls = Group{cols = 1}
	clss.group_controls:append_row(Button{style = "label", text =
...
* Left control: Camera rotation mode]]})
	-- Hints.
	clss.group_hints = Group{cols = 1}
	clss.group_hints:append_row(Button{style = "label", text =
...
things.]]})
	-- Contributing.
	clss.group_contributing = Group{cols = 1}
	clss.group_contributing:append_row(Button{style = "label", text =
