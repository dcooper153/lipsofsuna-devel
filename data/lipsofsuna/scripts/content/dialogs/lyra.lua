Dialogspec{name = "lyra",
	...
	{"branch", cond_not = "lyra introduced",
	  ...
	  {"say", "Expedition Leader Lyra", "Damnit, that torch is about to go out, I can see it flickering. Use Y to swap to first person mode if you can't see it.. Go fetch it, trust me, this is not a pleasant place to be stuck in the dark"},
