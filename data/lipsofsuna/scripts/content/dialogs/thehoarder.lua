		...
		{"choice", "Let's talk about the villagers.",
			{"choice", "Why do people live outdoors in this village?",
				...
				{"branch", cond_not = "silverspring hoarder problem known",
					{"quest", "The Hoarder", status = "active", text = "The Hoarder of Silvespring has told us about a problem with the townspeople. They sold the land to him but now keep burning the trees in a bonnfire."},
