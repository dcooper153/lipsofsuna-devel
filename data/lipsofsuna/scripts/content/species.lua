...
Species{
	name = "base",
	animations = {
		["attack axe"] = {animation = "attack-axe", channel = 2, fade_in = 0.1, weight = 100, node_weights = {LOWER = 1}},
		["attack blunt"] = {animation = "attack-blunt", channel = 2, fade_in = 0.1, weight = 100, node_weights = {LOWER = 1}},
		...
		["attack sword"] = {animation = "attack-sword", channel = 2, weight = 100, node_weights = {LOWER = 1}},
		["attack staff"] = {animation = "attack-staff", channel = 2, weight = 100, node_weights = {LOWER = 1}},
		...
		["charge axe"] = {animation = "charge-axe", channel = 2, fade_in = 0.1, permanent = true, repeat_start = 10, weight = 100, node_weights = {LOWER = 1}},
		["charge blunt"] = {animation = "charge-blunt", channel = 2, fade_in = 0.1, permanent = true, repeat_start = 10, weight = 100, node_weights = {LOWER = 1}},
		...
		["charge sword"] = {animation = "charge-blunt", channel = 2, permanent = true, repeat_start = 10, weight = 100, node_weights = {LOWER = 1}},
		["charge staff"] = {animation = "charge-axe", channel = 2, permanent = true, repeat_start = 10, weight = 100, node_weights = {LOWER = 1}},
		...
		["land ground"] = {animation = "land", channel = 5, fade_in = 0.1, fade_out = 0.1, weight = 10, node_weights = {LOWER = 1000}},
...
Species{
	...
	base = "race",
	animations = {
		["attack axe"] = {animation = "punch", channel = 2, fade_in = 0.1, weight = 100, node_weights = {LOWER = 1}},
		["attack blunt"] = {animation = "punch", channel = 2, fade_in = 0.1, weight = 100, node_weights = {LOWER = 1}},
		["attack sword"] = {animation = "punch", channel = 2, weight = 100, node_weights = {LOWER = 1}},
		["attack staff"] = {animation = "punch", channel = 2, weight = 100, node_weights = {LOWER = 1}},
