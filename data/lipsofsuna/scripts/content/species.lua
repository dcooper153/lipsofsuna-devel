...
Species{
	...
	animations = {
		...
		["attack crossbow"] = {animation = "fire-bow", channel = 2, weight = 100},
		["attack fist"] = {animation = "punch", channel = 2, fade_out = 0.1, weight = 100},
		["attack musket"] = {animation = "fire-bow", channel = 2, weight = 100},
		["attack revolver"] = {animation = "fire-bow", channel = 2, weight = 100},
		...
		["hold crossbow"] = {animation = "hold-right", channel = 3, permanent = true, repeat_start = 10, weight = 5},
		["hold musket"] = {animation = "hold-right", channel = 3, permanent = true, repeat_start = 10, weight = 5},
		["hold revolver"] = {animation = "hold-right", channel = 3, permanent = true, repeat_start = 10, weight = 5},
