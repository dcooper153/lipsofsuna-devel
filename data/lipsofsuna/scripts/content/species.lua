...
Species{
	...
	animations = {
		...
		["charge blunt"] = {animation = "charge-axe", channel = 2, fade_in = 0.1, permanent = true, repeat_start = 10, weight = 100},
		...
		["charge sword"] = {animation = "charge-axe", channel = 2, permanent = true, repeat_start = 10, weight = 100},
