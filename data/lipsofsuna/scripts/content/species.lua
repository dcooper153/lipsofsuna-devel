...
Species{
	...
	animations = {
		["attack left"] = {animation = "attack-axe", channel = 2, fade_in = 0.1, weight = 100, node_weights = {LOWER = 1}},
		["attack right"] = {animation = "attack-axe", channel = 2, fade_in = 0.1, weight = 100, node_weights = {LOWER = 1}},
		["attack front"] = {animation = "attack-axe", channel = 2, weight = 100, node_weights = {LOWER = 1}},
		["attack back"] = {animation = "attack-axe", channel = 2, weight = 100, node_weights = {LOWER = 1}},
		["attack stand"] = {animation = "attack-axe", channel = 2, weight = 100, node_weights = {LOWER = 1}},
		["charge axe"] = {animation = "charge-axe", channel = 2, fade_in = 0.1, permanent = true, repeat_start = 10, weight = 100, node_weights = {LOWER = 1}},
		["charge blunt"] = {animation = "charge-axe", channel = 2, fade_in = 0.1, permanent = true, repeat_start = 10, weight = 100, node_weights = {LOWER = 1}},
		["charge sword"] = {animation = "charge-axe", channel = 2, permanent = true, repeat_start = 10, weight = 100, node_weights = {LOWER = 1}},
