...
EXTS_DIRS = 'animation camera database graphics network object-physics object-render physics reload render skeleton sound speech tiles tiles-physics tiles-render widgets'
