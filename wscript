...
EXTS_DIRS = 'binding camera database effect generator graphics network npc object-physics object-render physics packager region reload render skeleton sound speech tiles tiles-physics tiles-render widgets'
