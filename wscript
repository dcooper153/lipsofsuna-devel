...
EXTS_DIRS = 'ai animation camera config-file database file graphics lobby model-editing network noise object-physics object-render password physics reload render skeleton sound speech thread tiles tiles-physics tiles-render vision widgets'
