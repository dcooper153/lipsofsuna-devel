...
CORE_DIRS = 'ai algorithm archive binding callback client engine extension generator main math model network particle paths physics render render/font render/image render/internal render/render21 render/render32 script server sound string system thread video voxel widget'
