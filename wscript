...
EXTS_DIRS = 'animation camera database graphics network noise object-physics object-render physics reload render skeleton sound speech tiles tiles-physics tiles-render widgets'
