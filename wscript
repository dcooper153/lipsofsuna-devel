...
EXTS_DIRS = 'binding camera chat creature database effect generator network npc packager region reload skeleton slots sound spawner speech tiles tiles-physics tiles-render widgets'
