...
EXTS_DIRS = 'ai animation config-file database file heightmap heightmap-physics image lobby math model model-editing model-merge network noise object password physics physics-object reload sectors skeleton sound string thread tiles tiles-physics time vision watchdog'
