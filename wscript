...
EXTS_DIRS = 'binding camera chat database effect generator network npc object-physics physics packager region reload skeleton slots sound speech tiles tiles-physics tiles-render widgets'
