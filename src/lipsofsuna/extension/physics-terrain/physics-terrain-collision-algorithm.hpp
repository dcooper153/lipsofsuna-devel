...
#ifndef __LIEXT_PHYSICS_TERRAIN_PHYSICS_TERRAIN_COLLISION_ALGORITHM_HPP__
#define __LIEXT_PHYSICS_TERRAIN_PHYSICS_TERRAIN_COLLISION_ALGORITHM_HPP__
...
public:
	struct CreateFunc : public btConvexConvexAlgorithm::CreateFunc
	{
		...
		virtual btCollisionAlgorithm* CreateCollisionAlgorithm (btCollisionAlgorithmConstructionInfo& ci, btCollisionObject* body0,btCollisionObject* body1)
		{
			...
			return new(mem) LIExtPhysicsTerrainCollisionAlgorithm (ci.m_manifold, ci, body0, body1, m_simplexSolver, m_pdSolver, m_numPerturbationIterations, m_minimumPointsPerturbationThreshold);
		}
	};
