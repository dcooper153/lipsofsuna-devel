 ...
 */
int limat_polygon_add_vertices (
	LIMatPolygon* self,
	const void*   vertices,
	int           count)
{
 ...
 * \return Nonzero on success.
 */
int limat_polygon_clip_with_planes (
	const LIMatPolygon* self,
 ...
 * \return Nonzero on success.
 */
int limat_polygon_clip_with_aabb (
	const LIMatPolygon* self,
 ...
 */
int limat_polygon_get_degenerate (
	const LIMatPolygon* self)
{
	int i;
	LIMatVector coord[3];
